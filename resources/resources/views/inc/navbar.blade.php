    ...
    <header class="navbar navbar-expand-lg navbar-dark fixed-top shadow-none header-mobile">
        <div class="container">
            <a href="/welcome" class="navbar-brand ms-4">
            ...
            @else
                <div class="nav dropdown d-block order-lg-3 ms-1">
                    <a href="#" class="d-flex nav-link p-0 a-toggle" data-bs-toggle="dropdown">
                        ...
                        <img src="{{ asset('public/assets/img/profile/' . Session::get('user_image')) }}" class="rounded-circle ms-2" style="height: 48px; width: 48px; object-fit:cover" />
