                ...
                <div class="col" >
                    <div
                        ...
                        <div
                            ...
                            <h3 class="h6 text-uppercase mb-2 mt-n4 mt-sm-0 mt-md-n4 mt-xxl-0">M5 World Championship
                            </h3>
                            <p class="fs-sm mb-1">Ongoing in Kuala Lumpur, Malaysia & Philippines.</p>
                            <a href="/team/{{ Auth::user()->id }}" class="btn btn-link text-warning stretched-link px-0">
                                View Team
                            </a>
                        </div>
                    </div>
