                                    ...
                                    @if ($game->status == 1)
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            @endif
                                                ...
                                                <img src="{{$league['logo'] }} " width="168" alt="Doctor icon" class="p-3 pe-0">
                                                <div class="card-body text-center text-sm-start text-md-center text-xxl-start pb-3 pb-sm-2 pb-md-3 pb-xxl-2">
                                                    ...
                                                    <a href="/league/{{ $game->id }}" class="btn btn-warning btn-sm rounded-pill my-2">
                                                        Join Now
                                            ...
                                            <div class="league">
                                                <div class="card pt-1 pb-3 flex-column flex-sm-row flex-md-column flex-xxl-row align-items-center border-warning h-100"
                                                    ...
                                                    <div
                                                        ...
                                                        <p class="fs-sm mb-1"> {{ $league['description'] }}</p>
                                                        <a class="btn btn-warning btn-sm rounded-pill disabled my-2" aria-disabled="true">
                                                            Join Now
                                                    ...
                                                    <div class="overlay zindex-2">
                                                        @if ($game->status == 0)
                                                            <h3 class="fw-bold text-warning"><b>Coming Soon</b></h3>
                                                        
                                                        @elseif ($game->status == 1)
                                                            <h3 class="fw-bold text-success"><b>Registration Open</b></h3>
                                                        
                                                        @elseif ($game->status == 2)
                                                            <h3 class="fw-bold text-danger"><b>Registration Closed</b></h3>

                                                        @else
                                                            <h3 class="fw-bold text-danger"><b>Event Ended</b></h3>
