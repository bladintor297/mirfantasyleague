    ...
    <section class="dark-mode hero bg-size-cover bg-repeat-0 bg-position-center position-relative overflow-hidden pb-5 " style="min-height: 100vh">
        <div class="container position-relative zindex-2 pb-md-2 pb-lg-4  hero-container ">
            ...
            <div class="row d-flex justify-content-center text-center pb-4 mb-2 zindex-5">
                <div class="col">
                    <h2 class="display-2 mb-4 text-warning">All Games</h2>
                </div>
            </div>

            <sup class="text-danger d-flex justify-content-end my-1">TW - Transfer Window; PL - Player Limit; RP - Reserve Player; RRsv - Reset Reserves</sup>
            <!-- Dark bordered table -->
                        ...
                        <tbody>
                            @foreach($games as $index => $game)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" data-bs-target="#EditGameDetails{{ $game->id }}" aria-controls="EditGameDetails{{ $game->id }}">Edit Details</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
