...
@section('content')
    <main class="page-wrapper" style="height: 100vh">
        <!-- Hero -->
        <section class="dark-mode bg-dark hero bg-size-cover bg-repeat-0 bg-position-center position-relative overflow-hidden pb-5 ">
            <div class="container position-relative zindex-2 pb-md-2 pb-lg-4  hero-container ">
                ...
                <div class="row d-flex justify-content-center text-center pb-4 mb-2 zindex-5">
                    <div class="col">
                        <h2 class="display-5 mb-4 text-warning">Privacy Policy</h2>
                    </div>
                </div>
                        ...
                        <div class="step-box" id="step">
                            <div class="row">
                                ...
                                <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection
                                    ...
                                    help of the <a href="https://www.termsfeed.com/privacy-policy-generator/"  class="text-warning" target="_blank">Privacy Policy
                                        Generator</a>.</p>
                                <h2 class="mt-3">Interpretation and Definitions</h2>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                                            or &quot;Our&quot; in this Agreement) refers to MIR Ventures, No 126A, Jalan Baru Pak Sabah, 23000
                                            Dungun, Terengganu.</p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <p><strong>Website</strong> refers to MIR Fantasy League, accessible from <a href="mirfantasyleague.com"
                                            class="text-warning"    rel="external nofollow noopener" target="_blank">mirfantasyleague.com</a></p>
                                    </li>
                                    <li>
                                ...
                                <ul>
                                    <li>By email: support@mirfantasyleague.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
