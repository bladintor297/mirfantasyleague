                    ...
                    <div class="card mt-3 card-hover">
                        ...
                        <div class="card-footer my-0 py-1 d-flex justify-content-center">
                            <a href="/hero/{{ $myteam->id }}/edit"
                                class="btn btn-sm py-1 btn-warning strechted-link px-5  rounded-pill my-2 {{ ($game->transfer_isOn == 0) ? '' : 'disabled' }}">
                        ...
                        <div class="modal-body">
                            <!-- Icon boxes (Features) -->
                                    ...
                                    <div class="steps">
                                        ...
                                        <form action="{{ route('myteam.update', ['myteam' => '1']) }}" method="post">
                                            @csrf
                                            @method('PUT')
