            ...
            <div class="row flex-nowrap mt-5 pt-5">
                <div class="col-lg-6 col-xl-5 text-center text-lg-start pt-3 mt-xl-4  py-5 mt-2">
                    <h1 class="display-3 pt-5 pb-2 pb-lg-1 mt-sm-2 mt-lg-5 fw-bold">
                        ...
                        <span class="header-parallax hero-title">Fantasy League xx</span>
                    </h1>
                    ...
                    <div class="swiper-slide h-auto pb-3">
                        <article class="card h-100 border-0 shadow-sm mx-2">
                            <div class="position-relative">
                                <img src="{{ asset('public/assets/img/home/feed/'.$post->image)  }}" class="card-img-top" alt="Image">
                            </div>
    ...
    <section class="position-relative pt-5 " >
        ...
        <div class="container position-relative pt-5">
            <div class="row mt-lg-3 pt-2 pt-md-3">
                <div class="col-xl-3 col-md-4 text-center text-md-start my-auto" >
