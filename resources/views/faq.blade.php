...
<!-- Hero -->
<section class="position-relative pt-5" style="background-color: #151922 !important;">
    ...
    <div class="container position-relative zindex-2 pt-5 pb-2 pb-md-0">
        ...
        <div class="row justify-content-center pt-3 mt-3">
            <div class="col-xl-6 col-lg-7 col-md-8 col-sm-10 text-center">
                ...
                <p class="text-white fs-lg pb-3 mb-3">Have a project in mind? To request a quote contact us directly or
                    fill out the form and let us know how we can help.</p>
                <div class="d-flex justify-content-center">
                    <a href="https://www.facebook.com/profile.php?id=61551020144213&mibextid=ZbWKwL"
                        class="btn btn-icon btn-secondary btn-facebook rounded-circle mx-2" aria-label="Facebook">
                        <i class="bx bxl-facebook"></i>
                    </a>
                    <a href="https://instagram.com/m5.fantasyleague/"
                        class="btn btn-icon btn-secondary btn-instagram rounded-circle mx-2" aria-label="Instagram">
                        <i class="bx bxl-instagram"></i>
                    </a>
                    <a href="mailto:support@mirfantasyleague.com"
                        class="btn btn-icon btn-secondary btn-google rounded-circle mx-2" aria-label="Google">
                        <i class="bx bxl-google"></i>
                    </a>
                    <a href="https://whatsapp.com/channel/0029Va96uAn6buMQ7bjbrg2N"
                        class="btn btn-icon btn-secondary btn-whatsapp rounded-circle mx-2" aria-label="Whatsapp">
    ...
    <div class="d-flex position-absolute top-100 start-0 w-100 overflow-hidden mt-n5 " style="color: #151922;">
        <div class="position-relative start-50 translate-middle-x flex-shrink-0 mt-n5 mt-md-n3 mt-lg-n1"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="3788" height="144" viewBox="0 0 3788 144">
                <path fill="currentColor" d="M0,0h3788.7c-525,90.2-1181.7,143.9-1894.3,143.9S525,90.2,0,0z" /></svg>
        </div>
    </div>
</section>
                ...
                <div class="accordion" id="faq">
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3" type="button"
                                ...
                                aria-controls="q-1">How to join this MIR Fantasy League?</button>
                        </h3>
                        <div class="accordion-collapse collapse show" id="q-1" data-bs-parent="#faq">
                            <div class="accordion-body fs-sm pt-0">
                                <p align="justify">
                                    Sign up your team at the “SIGN IN” tab. Check for any on-going tournament in the
                                    LEAGUE tab and select the tournament that you want to participate. Read and accept
                                    the Rules & Regulations, start to build up your strongest team by choosing the best
                                    players. Save your team, watch the tournament and see the winners in the SCOREBOARD
                                    tab!
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3 collapsed" type="button"
                                ...
                                aria-controls="q-2">Is there any participation fee?</button>
                        </h3>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                        ...
                        <div class="accordion-collapse collapse" id="q-4" data-bs-parent="#faq">
                            <div class="accordion-body fs-sm pt-0">
                                <p align="justify">
                                    You can check the prize pool in the PRIZES tab. Sometimes, the prize pool will be
                                    announced late (after the Fantasy League started). So, just stay tune for the prize
                                    pool update and stay supporting us!
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm mb-3">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3 collapsed" type="button"
                                ...
                                aria-controls="q-5">How the team score is calculated</button>
                        </h3>
                    ...
                    <div class="accordion-item border-0 rounded-3 shadow-sm">
                        <h3 class="accordion-header">
                            <button class="accordion-button shadow-none rounded-3 collapsed" type="button"
                                ...
                                aria-controls="q-6">How the winners will be contacted to claim their prizes?</button>
                        </h3>
