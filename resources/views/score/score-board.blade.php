                            ...
                            <div class="table-responsive">
                                <table class="table bg-white shadow" >
                                    <thead class="bg-dark thead">
                                            <th class="h4 border-bottom py-3 py-lg-4 mb-0 ps-3 "  width="10%">
                                                <h3 class="h4 mb-0  text-start">RANK</h3>
                                            </th>
                                            <th class="border-bottom py-3 py-lg-4 "  width="15%">
                                                <h3 class="h4 mb-0  text-start">POINTS</h3>
                                            </th>
                                            <th class="border-bottom py-3 py-lg-4"  width="20%">
                                                <h3 class="h4 mb-0  text-start">PLAYER</h3>
                                            </th>
                                            <th class="h4 border-bottom py-3 py-lg-4 mb-0 ps-3"  width="30%">
                                                <h3 class="h4 mb-0  text-start">TEAM</h3>
                                            </th>
                                            <th class="h4 border-bottom py-3 py-lg-4 mb-0 ps-3" >
                                                <h3 class="h4 mb-0  text-start">NATIONALITY</h3>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="tbody">
