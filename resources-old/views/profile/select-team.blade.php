                        ...
                        <div
                            ...
                            <img src="{{ url('assets/img/league/tournaments/MPL-Malaysia.png') }} "
                                ...
                                <div class="position-absolute top-0 start-0 m-2 mt-0 ms-0">
                                    <span class="badge bg-primary px-3">Team {{ $myTeam->label }}</span>
                                </div>
                            ...
                            <div
                                ...
                                <a href="/profile/{{ $myTeam->id }}"
                                    class="btn btn-sm py-1 btn-warning strechted-link px-3  rounded-pill my-2">
                                    <span class="text-dark">View Team</span>
                                </a>
                            </div>
                        </div>
                    </div>
